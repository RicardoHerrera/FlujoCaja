...
- (SGridColRowStyle *)shinobiGrid:(ShinobiGrid *)grid styleForRowAtIndex:          (int)rowIndex inSection:(int) sectionIndex __attribute__((warn_unused_result));
...
- (SGridColRowStyle *)shinobiGrid:(ShinobiGrid *)grid styleForColAtIndex:          (int)colIndex __attribute__((warn_unused_result));
...
- (SGridLineStyle *)  shinobiGrid:(ShinobiGrid *)grid     styleForHorizontalGridLineAtIndex: (int)gridLineIndex inSection:(int) sectionIndex __attribute__((warn_unused_result));
...
/** Asks the delegate for the style to be used for a particular vertical gridline within the ShinobiGrid object. 
 ...
 @return The SGridLineStyle object representing the style that will be applied to the gridline at `gridLineIndex` with `orientation`.*/
- (SGridLineStyle *)  shinobiGrid:(ShinobiGrid *)grid     styleForVerticalGridLineAtIndex:   (int)gridLineIndex __attribute__((warn_unused_result));
...
- (SGridSectionHeaderStyle *)shinobiGrid:(ShinobiGrid *)grid styleForSectionHeaderAtIndex:(int) sectionIndex __attribute__((warn_unused_result));
...
/** Tells the delegate that a cell within the ShinobiGrid grid object will begin editing.
 ...
 @warning *Important:* This method has been deprecated in preference of `shinobiGrid:willBegin:EditingAutoCell:`.
 
 @param grid The grid which contains the cell that will begin editing.
 @param cell The cell within `grid` that will begin editing.*/
- (void) shinobiGrid:(ShinobiGrid *)grid willCommenceEditingAutoCell:(const SGridTextInputCell *) cell  __attribute__((deprecated ("Use shinobiGrid:willBegin:EditingAutoCell: instead.")));
...
- (NSNumber*) shinobiGrid:(ShinobiGrid*) grid widthForResizingColAtIndex:(NSUInteger) columnIndex withCurrentWidth:(float) currentWidth targetWidth:(float) targetWidth __attribute__((warn_unused_result));
