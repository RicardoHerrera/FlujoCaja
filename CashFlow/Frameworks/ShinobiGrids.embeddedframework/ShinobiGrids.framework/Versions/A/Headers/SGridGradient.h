...
/**
An SGridGradient is a simple immutable container class for holding the colors
and locations of a gradient. These are applied to the `colors` and `locations`
properties of a CAGradientLayer.
*/

@interface SGridGradient : NSObject
