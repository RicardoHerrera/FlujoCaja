...
/** The style that will be applied to the header row in this grid.
 ...
 The header row is unaffected by defaultRowStyle, defaultAlternatingRowStyle and column styles. The header row style heirarchy is not subject to alpha blending as per blendLayeredStyleBackgroundColors and blendLayeredStyleTextColors.*/
...
- (NSUInteger) numberOfRowsForSection:(int)sectionIndex;
