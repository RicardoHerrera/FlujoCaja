...
/** An object of this type is used, in certain circumatances, to provide a style that will be used for an SGridCell. If this object contains a style that cannot be applied to the cell
 ...
 Note that where there are style conflicts, the application of style occurs according to the level of precidence.
